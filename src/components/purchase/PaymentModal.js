              ...
              <ul>
                <li className='has-view'>
                  <label for='check0' className='form-check'>
                    ...
                    <span>
                      <em className='mandatory'>(필수)</em>상기 결제내역과
                      이용약관 및 하단 유의사항에 동의합니다.
                    </span>
                  </label>
                ...
                <li>
                  <label for='check1' className='form-check'>
                    ...
                    <span>
                      ...
                      상품으로, 결제하신 이용권의 사용기간을 기준으로 하는 월
                      단위 상품으로, 결제하신 이용권의 사용기간 만료일자 1일 전
                      별도의 고지 없이 자동 정기 결제 되는 것에 동의합니다.
                    </span>
                  </label>
                </li>
              </ul>
