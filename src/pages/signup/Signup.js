    ...
    return (
        <StyledSignup>
            ...
            <div className="signup-sns-box">
                ...
                <a href='#' className="signup-t"><span className='hidden'>T 아이디로 로그인</span></a>
                <a href='#' className="signup-naver"><span className='hidden'>네이버 아이디로 로그인</span></a>
                <a href='#' className="signup-kakao"><span className='hidden'>카카오 계정으로 로그인</span></a>
                <a href='#' className="signup-apple"><span className='hidden'>Apple로 로그인</span></a>
            </div>
            <LoginFooter />
        </StyledSignup>
    );
