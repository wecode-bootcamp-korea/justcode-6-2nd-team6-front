...
const Charts = ({ genre, chart, musicTracks, setMusicTracks, setAlertOn, isExpandedClicked, allChart, setAllChart }) => {
                ...
                <div className="list-second-menu" >
                    <div className="song-info flex-center">
                        <input
                            ...
                            checked={
                                chart.length === checkedList.length ? true : false
                            }
                            onClick={() => {
...
const SongBar = ({ chart, musicTracks, setMusicTracks, isSelectClicked, checkedList, setCheckedList, onCheckedElement, isMoreMenuClicked, setIsMoreMenuClicked, setIsMyPlayListClicked, setAlertOn
    , visible }) => {
    const musicTracksId = musicTracks.map((el) => el.songId);
